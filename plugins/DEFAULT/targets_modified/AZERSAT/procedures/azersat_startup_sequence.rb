...
puts "\n Enabling ADCS (Attitude Determination and Control System) for solar tracking..."
adcs_result = cmd("AZERSAT ADCS_CTRL with STATE ON ")
puts "ADCS command result: #{adcs_result.inspect}"
wait(2)

# Step 3: Deploy Communication Antennas
puts "\n📡 Step 3: Deploying Communication Antennas"
puts "-" * 30
...
# Step 4: Monitor Power Generation
puts "\n🔋 Step 4: Monitoring Power Generation"
puts "-" * 30
...
# Step 5: Wait for sufficient battery charge
puts "\n⏳ Step 5: Waiting for Battery Charge (50% required for CHECKOUT mode)"
puts "-" * 30
...
# Step 7: Setup Thermal Control
puts "\n🌡️ Step 7: Setting up Thermal Control"
puts "-" * 30
...
# Step 8: Enable ADCS
puts "\n🎯 Step 8: Enabling ADCS for Solar Tracking"
puts "-" * 30
